...
(test dough-ratio
  "Calculate the grams of dough needed for given number and size of pizzas"
...
(test splash-of-sauces
  "Calculates the diameter of a pizza from the amount of sauce applied"
...
(test cheese-please
  "Calculates the number of pizzas of a certain size that can be made from an amount of cheese"
...
(test fair-share
  "Calculates if some number of pizzas can be evenly divided between friends"
